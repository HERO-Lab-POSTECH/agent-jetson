...
# The sim feeds obs[14:20] the FILTERED thruster state, not the raw command, so
# echoing the raw action here put the policy out of distribution and saturated
# the thrusters. The recurrence and its three constants are PINNED to the live
# sim (tau_up 0.1, tau_down 0.05, dt 0.02 = step_dt, NOT physics_dt) -- changing
# any of them changes what the policy sees. Which sim commit each value comes
# from, and why the earlier dt=0.005 was wrong:
#   docs/adr/005-obs-assembly-phase.md
